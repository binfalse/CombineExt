...
public class Iconizer
{
	...
	/** The Constant GENERIC_UNKNOWN representing the icon file for unknown file types. */
	public static final String GENERIC_UNKNOWN = "Blue-unknown.png";
	
	
	
	/**
	 * Get an icon file name given a format, as it can be found in our jar archive. Especially useful for people who are going to extract the icons. 
	 *
	...
	/**
	 * Get an icon stream given a format. This stream will ship the icon as it is stored in our jar file.
	 *
	 * @param format the format
	...
	{
		return Iconizer.class.getResourceAsStream ("/icons/" + formatToIcon (format));
	}
	...
	{
		URI format = new URI ("http://identifiers.org/combine.specifications/sbml.level-3.version-1.layout");
